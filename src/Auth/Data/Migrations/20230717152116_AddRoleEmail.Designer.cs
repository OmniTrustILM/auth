...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auth.Models.Entities.Action", b =>
                {
            ...
            modelBuilder.Entity("Auth.Models.Entities.Permission", b =>
                {
                    b.Property<Guid>("Uuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Auth.Models.Entities.Resource", b =>
                {
                    b.Property<Guid>("Uuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Auth.Models.Entities.Role", b =>
                {
                    b.Property<Guid>("Uuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Auth.Models.Entities.Permission", b =>
                {
                    b.HasOne("Auth.Models.Entities.Action", "Action")
                        .WithMany("Permissions")
                        .HasForeignKey("ActionUuid")
                        .OnDelete(DeleteBehavior.ClientCascade);

                    b.HasOne("Auth.Models.Entities.Resource", "Resource")
                        .WithMany("Permissions")
                        .HasForeignKey("ResourceUuid")
                        .OnDelete(DeleteBehavior.ClientCascade);

                    b.HasOne("Auth.Models.Entities.Role", "Role")
                        .WithMany("Permissions")
            ...
            modelBuilder.Entity("resource_action", b =>
                {
                    b.HasOne("Auth.Models.Entities.Action", null)
                        .WithMany()
                        .HasForeignKey("action_uuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Auth.Models.Entities.Resource", null)
                        .WithMany()
            ...
            modelBuilder.Entity("user_role", b =>
                {
                    b.HasOne("Auth.Models.Entities.Role", null)
                        .WithMany()
